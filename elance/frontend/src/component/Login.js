...
const validateForm=()=>{
    ...
    const handleSubmit=(e)=> {
        ...
        return(
          ...
          <a className="btn btn-outline-secondary btn-lg mx-5 p-0" type="button" onClick={handleSubmit} >Login</a>
           ...
           <a className="btn btn-outline-secondary my-2" type="button">SignUp with Google</a>
