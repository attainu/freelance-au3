                   ...
                   <div className="row mt-5">
                       ...
                       <div className="col-lg-6 mt-2 py-3 pl-5 ">
                             ...
                             <div className="row pl-2 pr-2">
                                ...
                                <h4 className="h4 mr-sm-2 ">Find the Best Talent</h4><input className="form-control mr-sm-2" type="text" placeholder="Search"/>
                                 {/* <button className="btn btn-outline-secondary my-2" type="btn">Search</button> */}
                                 <a className="btn btn-outline-secondary my-2" type="button">Search</a>
                                   </form>
                             ...
                             <div className="row mt-3 pl-3 mb-5 ">
                                 <ul className="nav">
                                 <a className="btn btn-outline-secondary mx-1" type="button">Programming</a>
                                 <a className="btn btn-outline-secondary mx-1" type="button">Design</a>
                                 <a className="btn btn-outline-secondary mx-1" type="button">Writing</a>
                                 <a className="btn btn-outline-secondary mx-1" type="button">Sales</a>
                                 <a className="btn btn-outline-secondary mx-1" type="button">Data-Science</a>
 ...
 <section className=" py-3 px-3 ">
             ...
             <div class="container-fluid px-4 mx-2">
                ...
                <div className="col-xl-4 mt-3 mb-0">
                    <div className="col-sm-4 offset-sm-4"><a className="btn btn-outline-secondary">Data-Science</a></div>
                    <img className="img-fluid mt-3" src={dataScience1} alt=""/>
                    </div>
                    
                    <div className="col-xl-4 mt-3 mb-0">
                    <div className="col-sm-4 offset-sm-4"><a className="btn btn-outline-secondary">Design</a></div>
                    <img className="img-fluid " src={design1} alt=""/>
                    </div>
                    <div className="col-xl-4 mt-3 mb-0">
                    <div className="col-sm-4 offset-sm-4"><a className="btn btn-outline-secondary">Writing</a></div>
                    <img className="img-fluid " src={content1} alt=""/>
                    </div>
                    <div className="col-xl-4 mt-3 mb-0">
                    <div className="col-sm-4 offset-sm-4"><a className="btn btn-outline-secondary">Sales</a></div>
                    <img className="img-fluid " src={sales1} alt=""/>
                    </div>
                    <div className="col-xl-4 mt-3 mb-0">
                    <div className="col-sm-4 offset-sm-4"><a className="btn btn-outline-secondary">Programming</a></div>
